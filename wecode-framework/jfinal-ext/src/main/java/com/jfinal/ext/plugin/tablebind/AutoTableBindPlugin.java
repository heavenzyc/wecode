...
public class AutoTableBindPlugin extends ActiveRecordPlugin {
    ...
    public boolean start() {
        List<Class<? extends Model>> modelClasses = ClassSearcher.of(Model.class).basePackage(basePackage).injars(includeJars).includeAllJarsInLib(includeAllJarsInLib).search();
        TableBind tb = null;
	...
	public AutoTableBindPlugin basePackage(String basePackage) {
