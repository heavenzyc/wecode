...
public class ClassSearcher {
    ...
    public <T> List<Class<? extends T>> search() {
    	...
    	if(this.basePackage != null) {
    		classFileList = findClassFilesWithBasePackage(this.basePackage);
    	}else {
    ...
    private static List<String> findClassFilesWithBasePackage(String basePackage) {
    	List<String> classFileList = new ArrayList<String>();
    	if(basePackage == null) {
    		LOG.error("basePackage is null.");
    	...
    	Set<BeanDefinition> beanDefinitions = provider.findCandidateComponents(base);
    	for (BeanDefinition beanDefinition : beanDefinitions) {
    		classFileList.add(beanDefinition.getBeanClassName());
		}
    	return classFileList;
    }
	...
	public ClassSearcher basePackage(String basePackage) {
