        ...
        <div class="col-sm-12 col-md-8" >
            ...
            <form id="add_input_info" class="form-horizontal" houseType="form" action="/transport/modify" method="post">
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="project_name" class="col-xs-10 col-sm-5" name="code" value="${data.code}" maxlength="20"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="count" class="col-xs-10 col-sm-5" name="send_address" value="${data.send_address}" maxlength="200"/>
                        <label id="unit"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="count" class="col-xs-10 col-sm-5" name="send_person" value="${data.send_person}" maxlength="20"/>
                        <label id="unit"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="count" class="col-xs-10 col-sm-5" name="send_person_phone" value="${data.send_person_phone}" maxlength="20"/>
                        <label id="unit"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="count" class="col-xs-10 col-sm-5" name="accept_merchant" value="${data.accept_merchant}" maxlength="50" />
                        <label id="unit"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="count" class="col-xs-10 col-sm-5" name="accept_address" value="${data.accept_address}" maxlength="100"/>
                        <label id="unit"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="count" class="col-xs-10 col-sm-5" name="accept_person" value="${data.accept_person}" maxlength="20"/>
                        <label id="unit"></label>
                    </div>
                </div>
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="structure" class="col-xs-10 col-sm-5" name="accept_person_phone" value="${data.accept_person_phone}" maxlength="20"/>
                    </div>
                </div>
                <div class="form-group"  >
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="car_num"  class="col-xs-10 col-sm-5" name="unit" value="${data.unit}" maxlength="10"/>
                    </div>
                </div>
                <div class="form-group"  >
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="weigh_person"  class="col-xs-10 col-sm-5" name="shipping_address" value="${data.shipping_address}" maxlength="50"/>
                    </div>
                </div>
                <div class="form-group"  >
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="weigh_person"  class="col-xs-10 col-sm-5" name="shipping_person_phone" value="${data.shipping_person_phone}" maxlength="20"/>
                    </div>
                </div>
                <div class="form-group"  >
                    ...
                    <div class="col-sm-10">
                        <div class="input-group" style="width:235px;">
                            <input id="end_join_time" class="form-control date-picker" name="send_time" value="${(data.send_time)?string('yyyy-MM-dd')}" type="text" data-date-format="yyyy-mm-dd">
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-10">
                        <div class="input-group" style="width:235px;">
                            <input id="end_join_time" class="form-control date-picker" name="off_time" value="${(data.off_time)?string('yyyy-MM-dd')}" type="text" data-date-format="yyyy-mm-dd">
                                <span class="input-group-addon">
                                    <i class="icon-calendar bigger-110"></i>
                                </span>
                        </div>
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="weigh_person"  class="col-xs-10 col-sm-5" name="car_num" value="${data.car_num}" maxlength="20"/>
                    </div>
                </div>
                <div class="clearfix form-actions">
