        ...
        <div class="col-sm-12" >
            ...
            <form id="add_output_info" class="form-horizontal" houseType="form" action="/output/modify" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" id="count" class="col-xs-11" name="count" value="${data.count}" maxlength="10"/>
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-2">
                        <input type="text" id="structure" class="col-xs-12" name="warehouse" value="${data.warehouse}" maxlength="50"/>
                    </div>
