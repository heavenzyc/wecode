        ...
        <div class="col-sm-12" >
            ...
            <form id="add_output_info" class="form-horizontal" houseType="form" action="/output/save" method="post">
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-2">
                        <input type="text" id="project_name" class="col-xs-12" name="project_name" maxlength="50"/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" id="count" class="col-xs-11" name="count" maxlength="10" datatype="s2-20" />
                        <label id="unit"></label>
                    </div>
                </div>
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-2">
                        <input type="text" id="structure" class="col-xs-12" name="warehouse" maxlength="50"/>
                    </div>
