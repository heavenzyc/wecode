...
<@we.breadcrumb current="账户信息页面配置"/>
        ...
        <div class="col-sm-12 col-md-8" >
            ...
            <form id="ac_form" class="form-horizontal" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="ac_title" placeholder="限20字符" class="col-xs-10 col-sm-5" name="ac_title"  value="${ac_title.dict_value!}" maxlength="20"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="ace-file-input ace-file-multiple pointer pull-left Js_upload_pics" data-crop="true" data-crop-size="320*200" data-obj="Js_success_logo" id="js_upload" data-config-code="COMMON" >
                            <div class="nopic-box">
                                <input id="ac_ad_pic" class="picvalue" name="ac_ad_pic" type="hidden" value="${ac_ad_pic.dict_value}" data-error-target="#js_upload" data-error-pos-my="center left" data-error-pos-at="center right">
                                <input class="picurl" type="hidden" value="<#if ac_ad_pic.dict_value?has_content>${kit.url('COMMON',ac_ad_pic.dict_value)}<#else></#if>">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">账户信息右侧图配置</label>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 广告图片 </label>
                    ...
                    <div class="col-sm-10">
                        <div class="ace-file-input ace-file-multiple pointer pull-left Js_upload_pics" data-crop="true" data-crop-size="100*100" data-obj="Js_success_logo" id="js_upload" data-config-code="COMMON" >
                            <div class="nopic-box">
                                <input id="ac_right_pic" class="picvalue" name="ac_right_pic" type="hidden" value="${ac_right_pic.dict_value}" data-error-target="#js_upload" data-error-pos-my="center left" data-error-pos-at="center right">
                                <input class="picurl" type="hidden" value="<#if ac_right_pic.dict_value?has_content>${kit.url('COMMON',ac_right_pic.dict_value)}<#else></#if>">
                                <label class="file-label" data-title="上传广告图片">
									<span class="file-name" data-title="No File ..."> <i class="icon-cloud-upload"></i>
									</span>
                                </label>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">可用${kit.dictValue(current_project.id,'point_name')}右侧图配置</label>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 广告图片 </label>
                    ...
                    <div class="col-sm-10">
                        <div class="ace-file-input ace-file-multiple pointer pull-left Js_upload_pics" data-crop="true" data-crop-size="100*100" data-obj="Js_success_logo" id="js_upload" data-config-code="COMMON" >
                            <div class="nopic-box">
                                <input id="ac_point_pic" class="picvalue" name="ac_point_pic" type="hidden" value="${ac_point_pic.dict_value}" data-error-target="#js_upload" data-error-pos-my="center left" data-error-pos-at="center right">
                                <input class="picurl" type="hidden" value="<#if ac_point_pic.dict_value?has_content>${kit.url('COMMON',ac_point_pic.dict_value)}<#else></#if>">
                                <label class="file-label" data-title="上传广告图片">
									<span class="file-name" data-title="No File ..."> <i class="icon-cloud-upload"></i>
									</span>
                                </label>
...
<script type="text/javascript">
    ...
    function saveRule(){
       ...
       var ac_ad_pic = $("#ac_ad_pic").val();
       var ac_right_pic = $("#ac_right_pic").val();
       var ac_point_pic = $("#ac_point_pic").val();
        if(title==null && ac_ad_pic==null && ac_right_pic==null && ac_point_pic==null) return;
        var data = $("#ac_form").serialize();
        $.ajax({
            url:'/admin/project/common_dict/ac_edit',
            type:'post',
            data:data,
