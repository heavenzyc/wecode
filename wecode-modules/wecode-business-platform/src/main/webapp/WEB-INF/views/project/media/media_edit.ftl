			...
			<div class="material clearfix">
				<div class="pview">
					<div id="JS_pview_box">
						<div class="module" id="JS_pictxt_0">
							<div class="potion">
								...
								<div class="con-pic Js_context_pic">
									封面图片
									<#if content.small_pic_url??>
									<img src="${content.small_pic_url}" style="width:100%;">
									</#if>
								</div>
						...
						<#list list as obj>
						<div class="pdt10 JS_pictxt_${obj_index+1}" id="JS_pictxt_${obj_index+1}" data="${obj_index+1}">
							<div class="module">
								<div class="potion">
									<div class="shade">
										<div class="bj"></div>
									...
									<span class="titxt val-title">${obj.title!'标题'} </span>
									<span class="imgbox"> 
										缩略图 
										<img src="${obj.small_pic_url}" style="width:100%;">
									</span>
								</div>
							</div>
						</div>
							...
							<div class="import" id="JS_conten_0" data="0">
								...
								<div class="conte">
									...
									<div>
										...
										<input class="form-control txtinput tooltip-info" id="title_0" data-input="val-title"  name="title" type="text" placeholder="标题（30个字以内）" maxlength="30" value="${content.title!''}">
									</div>
									<div class="space-6"></div>
									<label>封面图片</label>
									...
									<div class="ace-file-input ace-file-multiple pointer clearfix pull-left Js_upload_pics" data-obj="Js_context_pic" data-crop="true" data-crop-size="600*300" data-config-code="MEDIA" data-config-maxsize="10200000" data-config-type=".jpg|.bmp">
										<div class="nopic-box" style="display: none;">
											<input class="picvalue" name="pic" type="hidden" value="${content.small_pic_url}">
											<input class="oldpicvalue" name="old-pic" type="hidden" value="${content.org_pic_url}">
											<label class="file-label" data-title="上传封面图"> <span class="file-name" data-title="No File ..."> <i class="icon-cloud-upload"></i> </span> </label>
										</div>
										<div class="pic-con">
											<img src="${content.small_pic_url}" style="width:300px;">
											<a class="remove-btn Js_remove_pic" href="javascript:"> <i class="icon-remove"></i> </a>
										</div>
									</div>
									<div class="clearfix"></div>
									<div>
										<label>添加摘要</label>
										<textarea class="form-control limited txtinput" id="summary" name="summary" data-input="val-digest"  maxlength="120" placeholder="添加摘要">${content.summary!''}</textarea>
									</div>
									<div class="space-6"></div>
									<div>
										<label for="form-field-9">正文</label>
										<script class="JS_editor" type="text/plain" id="JS_editor_0">
											${content.content!''}
										</script>
									</div>
									<div class="space-6"></div>
									<div>
										<label>添加原文链接</label>
										<input class="form-control" id=""  name="page-url" type="text" placeholder="添加原文链接" value="${content.url!''}">
									</div>
								</div>
							</div>
							<#list list as obj>
								<div class="import hide" id="JS_conten_${obj_index+1}" data="${obj_index+1}">
								<span class="icons"></span>
								<div class="laytil">
									信息内容
								</div>
								<div class="conte">
									...
									<div>
										...
										<input class="form-control txtinput tooltip-info" id="title_0" data-input="val-title"  name="title" type="text" placeholder="标题（30个字以内）" maxlength="30" value="${obj.title!''}">
									</div>
									<div class="space-6"></div>
									<label>封面图片</label>
									<div class="clearfix"></div>
									<div class="ace-file-input ace-file-multiple pointer clearfix pull-left Js_upload_pics" data-obj="Js_context_pic" data-crop="true" data-crop-size="600*300" data-config-code="MEDIA" data-config-maxsize="10200000" data-config-type=".jpg|.bmp">
										<div class="nopic-box" style="display: none;">
											<input class="picvalue" name="pic" type="hidden" value="${obj.small_pic_url}">
											<input class="oldpicvalue" name="old-pic" type="hidden" value="${obj.org_pic_url}">
											<label class="file-label" data-title="上传封面图"> <span class="file-name" data-title="No File ..."> <i class="icon-cloud-upload"></i> </span> </label>
										</div>
										<div class="pic-con">
											<img src="${obj.small_pic_url}" style="width:300px;">
											<a class="remove-btn Js_remove_pic" href="javascript:"> <i class="icon-remove"></i> </a>
										</div>
									</div>
									<div class="clearfix"></div>
									<div>
										<label for="form-field-9">正文</label>
										<script class="JS_editor" type="text/plain" id="JS_editor_${obj_index+1}">
											${obj.content!''}
										</script>
									</div>
									<div class="space-6"></div>
									<div>
										<label>添加原文链接</label>
										<input class="form-control" id=""  name="page-url" type="text" placeholder="添加原文链接" value="${obj.url!''}">
									</div>
								</div>
							</div>
							</#list>
...
<textarea style="display:none" id="JS_edit_text">
	...
	<div class="conte">
		...
		<div>
			...
			<input class="form-control txtinput" id=""  name="title" type="text" data-input="val-title" placeholder="标题（30个字以内）" maxlength="30" value="">
		</div>
...
<script>
	function cancel_form() {
		window.location.href = "/admin/project/media/addIndex";
	}
	...
	$(function() {
		...
		<#list list as obj>
			ue[${obj_index+1}] = UE.getEditor("JS_editor_${obj_index+1}", options);
            a.push(${obj_index+1});
            synChronize(${obj_index+1});//同步左右数据
            addEditevent(${obj_index+1});//添加编辑事件
            addDelectevent(${obj_index+1});//添加删除事件
		</#list>
		var flag = ${list?size}+1;
		...
		$(".Js_material_submit").on("click", function() {
			...
			var posturl = "/admin/project/media/editMedia", postdata = {
				"id" : _id,
				"titles" : _title,
			...
			WG.fn.ajax(posturl, postdata, function(data) {
				if (data.success == true) {
					window.location.href = "/admin/project/media";
