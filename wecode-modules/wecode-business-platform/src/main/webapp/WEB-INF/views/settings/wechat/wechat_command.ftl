		...
		<div class="col-xs-12">
			...
			<div class="tabbable tabs-left">
				<ul class="nav nav-tabs">
					...
					<li>
						<a href="${base}/admin/settings/wechat/commandKeyReplyIndex"> 关键词自动回复 </a>
					</li>
				</ul>
...
<script>
	...
	$("#news_form").attr("action", "/admin/settings/wechat/commandReply");
	$("#news_form").submit();
	});

	$(".Js_submit_text").on("click", function() {
	$("#text_form").attr("action", "/admin/settings/wechat/commandReply");
	$("#text_form").submit();
	});
