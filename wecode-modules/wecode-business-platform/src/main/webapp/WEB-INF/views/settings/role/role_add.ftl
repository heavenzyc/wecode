...
<@we.breadcrumb current="创建角色"/>

<div class="page-content">
	<div class="row">
		<div class="col-xs-12">
			<form class="form-horizontal" role="form" action="${path}/admin/settings/role/saveRole" method="post" id="formAdd">
				<div class="form-group">
					<label class="col-sm-1 control-label no-padding-left" for="form-field-name">角色名称</label>

					<div class="col-sm-11">
						<input type="text" autocomplete="off" placeholder="角色名称" class="col-xs-10 col-sm-5 js-required" name="name" id="name" onblur="checkName();"/>
					</div>
				</div>
				<!--
				...
				<#list resList as menu1>
				<div class="step-box">
					<div class="first-step">
						<label>
							<input name="form-field-checkbox" type="checkbox" class="ace Js_check_first" value="${menu1.id}"/>
					...
					<div class="widget-box transparent" style="padding-left:15px;">
						<div class="widget-header widget-header-flat">
							<h4 class="lighter">
								<label>
									<input name="form-field-checkbox" type="checkbox" class="ace Js_check_f" value="${menu2.id}" />
								...
								<div class="widget-main padding-4 clearfix">
									<div class="form-group col-sm-10">
										...
										<label style="margin-right:20px">
											<input name="form-field-checkbox" type="checkbox" class="ace Js_check_s" value="${menu3.id}" />
