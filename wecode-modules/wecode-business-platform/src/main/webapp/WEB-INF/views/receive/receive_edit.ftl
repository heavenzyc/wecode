        ...
        <div class="col-sm-12" >
            ...
            <form id="add_receive_edit" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" id="count" class="col-xs-12" name="merchant" value="${data.merchant}" maxlength="50"/>
                    </div>

                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1">收款负责人</label>
                    <div class="col-sm-2">
                        <input type="text" class="col-xs-12" name="receive_person" value="${data.receive_person}"  maxlength="20"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <label>
                            <input id="cash" name="receive_type" value="TRANS" type="radio" class="ace" <#if data.receive_type=='TRANS'>checked</#if> onclick="changeCash()"/>
                        ...
                        <label <#if data.receive_type!='CHECK'>class="hidden Js_check"</#if>>
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-2">
                        <input type="text" id="money" class="col-xs-12" name="money" value="${data.money}" maxlength="10"/>
                    </div>
                </div>
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-2">
                        <input type="text" id="arrears" class="col-xs-12" name="arrears" value="${data.arrears}" maxlength="10"/>
                    </div>
